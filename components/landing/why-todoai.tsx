        ...
        >
          {stats.map((stat, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="text-center bg-gray-900/50 border border-gray-800 rounded-lg p-6 hover:border-red-500/30 transition-colors"
            >
              ...
              >
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-green-400 font-medium">{testimonial.progress}</div>
                  </div>
                </div>
